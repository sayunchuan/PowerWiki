...
![GaWiki Logo](https://img.shields.io/badge/GaWiki-Markdown%20Wiki-blue?style=for-the-badge)
...
```bash
git clone https://github.com/your-username/gawiki.git
cd gawiki
```
...
- 提交 [Issue](https://github.com/your-username/gawiki/issues)
